...
df = pd.DataFrame(metrics.classification_report(twenty_test.target,
                                                predicted, target_names=twenty_test.target_names, output_dict=True)).transpose()
writer = ExcelWriter('Part_B_LR_results.xlsx')
df.to_excel(writer, 'logistic_regession')
writer.save()
